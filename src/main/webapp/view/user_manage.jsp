                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="titleCenter titleCenter27"
                                                                                            ...
                                                                                            <div class="titleText titleText27">
                                                                                                <span class="bannerNormalTitle fk_mainTitle mainTitle mainTitle27">用户管理</span>
                                                                                            </div>
                                                                                        </td>
                                                                        ...
                                                                        <tr valign="top">
                                                                            <td height="258" width="100%">
                                                                                <table align="center" width="100%"
                                                                                    ...
                                                                                    <tr align="center" bgcolor="#e64a19"
                                                                                        onMouseOver="">
                                                                                    ...
                                                                                    <tr align="center" height="35px">
                                                                                        <td style="background-color:#f5b6a2"><%=user.getId() %>
                                                                                        </td>
                                                                                        <td style="background-color:#f5b6a2"><%=user.getUsername() %>
                                                                                        </td>
