    ...
    <div id="memberBar" class="memberBar">
        <div class="right">
            <div style="float:right;">
                <a class="memberOption memberLogin" href="javascript:Site.memberSignup();" style="margin-right:10px;">注册</a>
                <a class="memberOption memberReg" href="javascript:Site.memberLogin();">登录</a>
            </div>
        </div>
        <div id="topBarMsg"
...
<script>
    $(".login").click(function () {
        ...
        $.ajax({
            url: "http://localhost:8080/MusicRecommenderSystem2/login",
            type: "POST",
